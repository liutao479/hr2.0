...
(function(_) {
	...
	*/
	...
	_.$http.apiMap = {
		...
		mortgageStatis: 'http://192.168.0.155:8080/loanPledge/getLoanPledgeList',
		...
		licenceStatis: 'http://192.168.0.155:8080/loanRegistration/getLoanRegistrationList',
		expireProcess: 'http://127.0.0.1:8083/mock/expire.process',
		creditArchiveDownload: 'http://192.168.0.155:8080/creditUser/getCreditMaterials',
		loadArchiveDownload: 'http://192.168.0.155:8080/creditUser/getCreditMaterials',
		moneyBusinessAuditPrint: 'http://192.168.0.155:8080/loanUserStage/getFinancialData',
		auditPrint: 'http://192.168.0.155:8080/loanUserStage/getFinancialData',
		operationsAnalysis: 'http://127.0.0.1:8083/mock/operationsAnalysis',
		organizationManage: 'http://127.0.0.1:8083/mock/organizationManage',
